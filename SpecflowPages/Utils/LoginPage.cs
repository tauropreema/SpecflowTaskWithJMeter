  ...
  public class LoginPage
    {
        public static void LoginStep()
        {
            ...
            //Enter Username
            Driver.driver.FindElement(By.XPath("//input[@name='email']")).SendKeys("vnavyareddy036@gmail.com");

            //Enter password
            Driver.driver.FindElement(By.XPath("//input[@name='password']")).SendKeys("SydneyQa2019");
            Thread.Sleep(1000);
